...
\end{figure}
Le tube à choc est composé de deux tubes en PVC séparés par une membrane. Le but étant avec une pompe à vélo de pomper la partie gauche, donc la pression sera élevée. A partir d’une pression P, la membrane se brisera et la discontinuité de pression dans le tube créera l’onde de choc et l’explosion à la sortie du tube.
...
\subsubsection{\normalfont{\textit{$1^{er}$ essai : onde de choc hydraulique}}}
...
\begin{figure}[H]
	\centering
	\includegraphics[scale = 0.43]{figures/choc_hydro.png}
	\caption{\small{\textit{Schéma du test réalisé à l'aide de la pompe hydraulique : 2,5 bars}}}
...
\end{table}
Le matériau le plus concluant s’est avéré être le scotch type “gaffer”, il a donc été conservé pour réaliser un test filmé. Les images de la figure~\ref{fig:choc_filmee} ont été prises après avoir placé le canon du générateur à onde de choc en face d’un récipient rempli d’eau (1 seule couche de scotch, rupture à 2,5 bars) :\\
\begin{figure}[H]
	\centering
